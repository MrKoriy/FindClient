...
WELCOME = (
    ...
    "📨 <b>Рассылки + CRM</b> — цепочки сообщений в Telegram с ваших аккаунтов, демо-сайт под каждого лида, "
    "AI-классификация ответов.\n"
    "🧠 <b>Офферы</b> — приёмы из видео и каналов креаторов → ваш оффер под нишу.\n\n"
