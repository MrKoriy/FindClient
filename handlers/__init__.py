...
from handlers.outreach import router as outreach_router
...
def register_routers(dp: Dispatcher) -> None:
    ...
    for router in (start_router, scrape_router, niches_router, orders_router, outreach_router,
                   offers_router, tg_router, history_router, stats_router):
